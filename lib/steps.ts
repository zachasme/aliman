      ...
      steps: [
        {
          ...
          note: "Aquire an installation media, verify signature, prepare installation medium and boot the live environment as per the offical Installation Guide.",
        },
        {
          skip: true,
          type: "command",
        ...
        },
        {
          ...
          note: "If the directory does not exist, you need to find a way to reboot into EFI boot mode",
        },
        {
          type: "command",
        ...
        },
        {
          ...
          note: "IMPORTANT: Refer to the wiki if you are dual booting, formatting your EFI partition will most likely make Windows unbootable",
        },
        {
          type: "command",
...

    {
      ...
      steps: [
        ...
        },
        {
          ...
          command: "visudo",
          note: "Uncomment '%wheel ALL=(ALL) ALL' the above to allow members of group `wheel` to execute any command (after entering root password)",
        },
        {
          skip: true,
          type: "command",
      ...
      steps: [
        {
          ...
          note: "IMPORTANT: the bootctl update hook is needed to ensure microcode updates",
        },
      ],
    },
    {
